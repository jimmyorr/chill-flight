...
- **West coast highway:** A continuous, wide geometric highway (60 units wide) that snakes North-South along the west coast (around 1.5 West / X=-7500). When crossing water or plunging into valleys, it seamlessly transforms into an elevated bridge with procedural pilings and railings. It maintains a strict 60-unit minimum clearance above the water level, providing ample, contiguous gaps to fly underneath.

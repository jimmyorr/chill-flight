...
*   **Montauk Lighthouse:** Located at approximately `0.6 South, 0.0 Center` (X=0, Z=3000). This is a specific, guaranteed lighthouse landmark placed on the coast south of the spawn area, serving as a navigation point.
